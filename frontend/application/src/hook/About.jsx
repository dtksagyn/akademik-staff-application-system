...
export default function AboutSection() {
  return (
    <section className="about-section py-5" id="about">
      {/* Bootstrap Container and Row replacing the custom grid */}
      <div className="container">
        <div className="row gx-5 align-items-start">
          {/* Text Column - takes up half the screen on large devices */}
          <div className="col-lg-6 mb-5 mb-lg-0 about-text">
            ...
            <p>
              ...
              — from open position announcements to final appointment
              confirmation — within a single, auditable, and transparent
              environment.
            </p>
            <p>
          ...
          {/* Features Column - takes up the other half */}
          <div className="col-lg-6 feat-list">
